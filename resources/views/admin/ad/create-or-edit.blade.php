            ...
            @csrf
                        ...
                        <div class="mt-6 space-y-6 sm:mt-5 sm:space-y-5">
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                    ...
                                    <div class="flex justify-center max-w-lg px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md" id="image-uploader">
                ...
                <div class="pt-5">
                    <div class="flex items-center justify-between">
                        ...
                        <x-button onclick="this.disabled=true;this.value='Sending, please wait...';this.form.submit();">{{ __('Save') }}</x-button>
                    </div>
                </div>
            </form>
        </div>
