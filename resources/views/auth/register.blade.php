<x-layout>
    <div class="flex flex-col items-center min-h-screen my-3 md:my-10 sm:justify-center">

        <div class="w-full px-6 py-4 my-3 lg:my-10 overflow-hidden bg-white shadow-md sm:max-w-4xl sm:rounded-lg">
            <!-- Validation Errors -->
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-8">
                ...
                <div class="pt-5">
                    <div class="flex items-center justify-between">
                        <a href="#" class="text-sm font-semibold text-blue"><span aria-hidden="true">&larr;</span> {{ __('Back') }}</a>
