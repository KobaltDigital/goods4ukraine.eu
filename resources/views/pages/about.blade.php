    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-6 overflow-hidden shadow rounded-lg mb-10max-w-none">
                ...
                <ul role="list" class="p-10 mx-auto grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-4 md:gap-x-6 lg:max-w-5xl lg:gap-x-10 lg:gap-y-12 xl:grid-cols-4">
                    @foreach($volunteers as $volunteer)
                        <li>
                            <a href="{{ $volunteer['url'] }}" class="space-y-4 text-center border border-white hover:border-blue hover:bg-white block p-3 rounded">
                                <img class="mx-auto h-20 w-20 rounded-full lg:w-24 lg:h-24" src="{{ $volunteer['img'] }}" alt="{{ $volunteer['name'] }}">
                                <div class="space-y-2">
