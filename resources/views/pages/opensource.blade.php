    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-6 overflow-hidden shadow rounded-lg mb-10 prose max-w-none">
                ...
                <p>
                    Het plaatsen werkt als volgt, je registreert je met je e-mailadres zodat je je advertentie eventueel
                    kunt aanpassen of kunt sluiten. Reageert iemand op je aanbod, dan ontvang je een mail. Je kunt er
