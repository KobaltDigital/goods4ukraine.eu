            ...
            <div class="bg-white p-6 overflow-hidden shadow rounded-lg mb-10 prose max-w-none">
                ...
                <div class="section-link-block">
                    <div class="link-block-content">
                        ...
                        <ol>
                            ...
                            <li><a href="#plaatsen">Het plaatsen van een aanbieding</a></li>
                            <li><a href="#ontbindingsrecht">Ontbindingsrecht</a></li>
                            <li><a href="#betaalmethoden">Regels voor het aanbieden van de prijs/betaalmethoden in
                                        een aanbieding</a>
                            </li>
                            ...
                            <li>
                                <a href="#gepubliceerd">De aanbieding kan ook elders gepubliceerd
                                        worden</a>
                            </li>
                        </ol>
                    </div>
                ...
                <div class="help-content separated">
                    ...
                    <p>Voor uw veiligheid en om misbruik tegen te gaan worden e-mailadressen afgeschermd door
                        ...
                        veilig mogelijk blijft.   <a name="oneigenlijkgebruik"></a> Indien wij
                    ...
                    <p>De Website bevat verwijzingen naar de websites van derden (bijvoorbeeld door middel van een
                        ...
                        onder de (privacy)regels van de desbetreffende dienstverlener vallen.<strong>
                            </strong><a name="klachtenregeling"></a></p>
                    ...
                    <p>2.1&nbsp; aanbiedings die door een aanbieder op de Website worden geplaatst, dienen aan
                        ...
                        aanvullende regels kunnen afwijken van de onderstaande algemene regels. <strong>Wij adviseren u
                            om altijd goed op te letten onder welke regels een aanbieding valt.<b> </b></strong>
                    </p>

                    <p>2.2 Het opmaken van een aanbieding:<strong> </strong></p>
                    <p>a. In iedere aanbieding voor producten mag maar &eacute;&eacute;n concreet product worden
                        aangeboden of worden gezocht.b. Elke titel en elke tekst van een aanbieding dienen
                        een omschrijving van het aangeboden of gezochte product of de aangeboden of gezochte dienst te
                        bevatten.c. Titels en teksten van aanbiedings mogen alleen in het Nederlands of in
                        het Engels zijn opgesteld.
                    ...
                    <p>2.3 aanbieding-inhoud die niet is toegestaan: a. De titel en de tekst van de
                        ...
                        beschrijven. b. Het is niet toegestaan om bepaalde wettelijke rechten, zoals het
                        recht
                        ...
                        vergoeding voor te vragen of deze alleen tegen vergoeding te respecteren.c. Een
                        ...
                        d. Het is niet toegestaan een aanbieding te plaatsen met als enige doel het direct
                        of
                        indirect promoten van een bedrijf, behalve in de groep Diensten en Vakmensen.e. Het
                        is
                        niet toegestaan om foto&rsquo;s bij een aanbieding te plaatsen die geen betrekking hebben op
                        het aangeboden product of de aangeboden dienst.f. In gratis aanbiedings mogen enkel
                        ...
                        gericht zijn op het verwerken van aanbieding-inkomsten door het genereren van kliks.
                        g. Het is niet toegestaan om aanbiedings te plaatsen, die enkel zijn geplaatst om kliks op een
                        bepaalde website te genereren.<strong></strong>2.4 Illegale of onrechtmatige
                        producten
                        of diensten
                    </p>
                    ...
                    <p>Zowel aanbieder als Gebruiker dienen zelf altijd goed op te letten bij het aanbieden van en
                        ...
                        of diensten suggesties. <strong></strong>2.5 Geen inbreuk op intellectueel
                        eigendomsrechten van derdena. Het is niet toegestaan om een product in een
                        aanbieding
                    ...
                    <p style="padding-left: 30px;">(i) inbreuk maakt op het auteursrecht van een andere partij,
                    ...
                    <p style="padding-left: 30px;">(ii) inbreuk maakt op het merkenrecht van een andere partij, zoals
                        ...
                        of(iii) inbreuk maakt op het modelrecht van een andere partij, zoals een tas die is
                    ...
                    <p>b. In de titel en tekst van de aanbieding mag slechts de merknaam van het product worden
                        gebruikt dat in de aanbieding wordt aangeboden of gevraagd.c. In de titel of de
                        tekst
                        ...
                        toegestaan.d. Het product mag alleen in de tekst van de aanbieding met andere
                        ...
                        geen merknaam behorende bij het andere vergelijkbare product worden genoemd. e. Het
                        is
                    ...
                    <p>3.2. Totstandkoming aanbiedingovereenkomst tussen Goods4ukraine.eu en aanbiedera.
                        ...
                        staanaanbiedings waarvoor geen bijzondere regels gelden blijven tenminste 28 dagen op de
                    ...
                    <p style="padding-left: 30px;">(i) het aangaan van een overeenkomst op basis van een
                        aanbieding,(ii) het gebruik van via de Website gekochte producten; en(iii) het
                        gebruik van via de Website aangeboden diensten; en
